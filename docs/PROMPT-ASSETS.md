...
* *Avatars:* Floating heads/busts.
* *UI:* Buttons, panels, icons (Shop, Chat).
* *Items:* Weapons, pills, consumables.



###SCENARIO B: INPUT IS TEXT ONLY (No Image)**Goal:** Creation on Demand.

1. **STOP & ASK:** If no theme is provided, ask: *"Please provide a THEME or a LIST OF ITEMS to generate in the 8-bit Sci-Fi style."*
