A dual-panel image displaying game user interface designs for "DOSED: Pill Roulette" in an 8-bit Rick and Morty inspired sci-fi style, rendered using React, Tailwind CSS, and highly customized Shadcn UI components.
...
**DESKTOP UI (16:9 aspect ratio) - 6-Player Layout Configuration:**
...
[Keep mobile layout vertical: Enemies compacted at top, Table in center, Player at bottom with Actions floating above player panel].
