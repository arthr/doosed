...
import { Header } from '../components/draft_extra/Header';
import { ShopItem } from '../components/draft_extra/ShopItem';
import { InventorySlot } from '../components/draft_extra/InventorySlot';
...
export default function DraftExtraScreen() {
  // State
