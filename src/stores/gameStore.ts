...
const initialState: IGameState = {
  ...
  players: [
    ...
    },
    {
      ...
      isDead: false,
      inventory: [
        { id: 'item-1', name: 'Beer', icon: '🍺', description: 'Cura 1 HP' },
        { id: 'item-2', name: 'Magnifying Glass', icon: '🔍', description: 'Reveal a pill' },
        { id: 'item-3', name: 'Handcuffs', icon: ' handcuff', description: 'Skip opponent turn' },
        { id: 'item-4', name: 'Knife', icon: '🔪', description: 'Deal 1 damage' },
        { id: 'item-5', name: 'Syringe', icon: '💉', description: 'Antidote' },
        { id: 'item-6', name: 'Portal Gun', icon: '🔫', description: 'Escape' },
        { id: 'item-7', name: 'Seed', icon: '🌰', description: 'Boost intelligence' },
