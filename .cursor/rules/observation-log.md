...
- Se a observação virar regra permanente, mover/replicar para `docs/v2` ou para as rules em `.cursor/rules`.
...
- [Docs] Ao alterar estrutura/nomes de pastas/endpoints, atualizar primeiro `docs/v2/00-start-here/estrutura-do-projeto.md` e depois alinhar `steering/`.
